...
--
-- Name: current_user_organization_id(); Type: FUNCTION; Schema: auth; Owner: postgres
--

CREATE FUNCTION auth.current_user_organization_id() RETURNS uuid
...
ALTER FUNCTION auth.current_user_organization_id() OWNER TO postgres;
...
--
-- Name: get_user_role(); Type: FUNCTION; Schema: auth; Owner: postgres
--
...
ALTER FUNCTION auth.get_user_role() OWNER TO postgres;
...
--
-- Name: application_customers; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.application_customers OWNER TO postgres;

--
-- Name: application_events; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: asset_ownership; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.asset_ownership OWNER TO postgres;
...
CREATE TABLE public.declarations (
    ...
    undisclosed_borrowed_amount numeric(12,2),
...
CREATE TABLE public.employments (
    ...
    self_employed_monthly_income numeric(12,2),
...
--
-- Name: gift_funds; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.gift_funds (
    ...
    gift_amount numeric(12,2) NOT NULL,
    gift_date date,
...
ALTER TABLE public.gift_funds OWNER TO postgres;
...
--
-- Name: liability_ownership; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.liability_ownership OWNER TO postgres;
...
--
-- Name: real_estate_owned; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.real_estate_owned (
    ...
    monthly_insurance_taxes_hoa numeric(12,2),
    ...
    mortgage_unpaid_balance numeric(12,2),
    mortgage_to_be_paid_off boolean DEFAULT false,
    mortgage_type text,
    has_heloc boolean DEFAULT false,
    heloc_credit_limit numeric(12,2),
    heloc_balance numeric(12,2),
...
ALTER TABLE public.real_estate_owned OWNER TO postgres;
...
--
-- Name: application_customers application_customers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_customers
    ADD CONSTRAINT application_customers_pkey PRIMARY KEY (id);


--
-- Name: application_events application_events_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: applications applications_application_number_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.applications
    ADD CONSTRAINT applications_application_number_unique UNIQUE (application_number);
...
--
-- Name: asset_ownership asset_ownership_asset_id_customer_id_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.asset_ownership
    ADD CONSTRAINT asset_ownership_asset_id_customer_id_pk PRIMARY KEY (asset_id, customer_id);
...
--
-- Name: gift_funds gift_funds_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.gift_funds
    ADD CONSTRAINT gift_funds_pkey PRIMARY KEY (id);
...
--
-- Name: liability_ownership liability_ownership_liability_id_customer_id_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.liability_ownership
    ADD CONSTRAINT liability_ownership_liability_id_customer_id_pk PRIMARY KEY (liability_id, customer_id);
...
--
-- Name: real_estate_owned real_estate_owned_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.real_estate_owned
    ADD CONSTRAINT real_estate_owned_pkey PRIMARY KEY (id);
...
--
-- Name: applications_primary_customer_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX applications_primary_customer_id_idx ON public.applications USING btree (primary_customer_id);


--
-- Name: customers_auth_user_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: customers_auth_user_id_unique; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: declarations_customer_application_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX declarations_customer_application_idx ON public.declarations USING btree (customer_id, application_id);


--
-- Name: demographics_customer_application_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX demographics_customer_application_idx ON public.demographics USING btree (customer_id, application_id);


--
-- Name: employments_customer_application_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX employments_customer_application_idx ON public.employments USING btree (customer_id, application_id);


--
-- Name: incomes_customer_application_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX incomes_customer_application_idx ON public.incomes USING btree (customer_id, application_id);


--
-- Name: invitation_tokens_app_cust_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX invitation_tokens_app_cust_idx ON public.invitation_tokens USING btree (application_customer_id);


--
-- Name: invitation_tokens_token_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX invitation_tokens_token_idx ON public.invitation_tokens USING btree (token);


--
-- Name: real_estate_owned_customer_application_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX real_estate_owned_customer_application_idx ON public.real_estate_owned USING btree (customer_id, application_id);


--
-- Name: residences_customer_application_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX residences_customer_application_idx ON public.residences USING btree (customer_id, application_id);
...
--
-- Name: application_customers application_customers_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_customers
    ADD CONSTRAINT application_customers_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: application_customers application_customers_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_customers
    ADD CONSTRAINT application_customers_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: application_customers application_customers_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_customers
    ADD CONSTRAINT application_customers_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: application_customers application_customers_organization_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_customers
    ADD CONSTRAINT application_customers_organization_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: application_events application_events_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_events
    ADD CONSTRAINT application_events_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id) ON DELETE CASCADE;


--
-- Name: application_events application_events_organization_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_events
    ADD CONSTRAINT application_events_organization_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: application_events application_events_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_events
    ADD CONSTRAINT application_events_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: applications applications_assigned_to_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.applications
    ADD CONSTRAINT applications_assigned_to_users_id_fk FOREIGN KEY (assigned_to) REFERENCES public.users(id);


--
-- Name: applications applications_loan_product_id_loan_products_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.applications
    ADD CONSTRAINT applications_loan_product_id_loan_products_id_fk FOREIGN KEY (loan_product_id) REFERENCES public.loan_products(id);


--
-- Name: applications applications_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.applications
    ADD CONSTRAINT applications_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: applications applications_primary_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.applications
    ADD CONSTRAINT applications_primary_customer_id_fkey FOREIGN KEY (primary_customer_id) REFERENCES public.customers(id) ON DELETE SET NULL;


--
-- Name: applications applications_property_id_properties_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: asset_ownership asset_ownership_asset_id_assets_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.asset_ownership
    ADD CONSTRAINT asset_ownership_asset_id_assets_id_fk FOREIGN KEY (asset_id) REFERENCES public.assets(id);


--
-- Name: asset_ownership asset_ownership_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.asset_ownership
    ADD CONSTRAINT asset_ownership_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: assets assets_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assets
    ADD CONSTRAINT assets_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);
...
ALTER TABLE ONLY public.assets
    ADD CONSTRAINT assets_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: communications communications_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.communications
    ADD CONSTRAINT communications_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: communications communications_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.communications
    ADD CONSTRAINT communications_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: communications communications_initiated_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.communications
    ADD CONSTRAINT communications_initiated_by_users_id_fk FOREIGN KEY (initiated_by) REFERENCES public.users(id);


--
-- Name: communications communications_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.communications
    ADD CONSTRAINT communications_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);
...
--
-- Name: declarations declarations_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.declarations
    ADD CONSTRAINT declarations_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: declarations declarations_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.declarations
    ADD CONSTRAINT declarations_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: declarations declarations_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.declarations
    ADD CONSTRAINT declarations_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: demographics demographics_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.demographics
    ADD CONSTRAINT demographics_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: demographics demographics_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.demographics
    ADD CONSTRAINT demographics_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: demographics demographics_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.demographics
    ADD CONSTRAINT demographics_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: documents documents_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: documents documents_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: documents documents_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT documents_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: documents documents_reviewed_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT documents_reviewed_by_users_id_fk FOREIGN KEY (reviewed_by) REFERENCES public.users(id);
...
--
-- Name: employments employments_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employments
    ADD CONSTRAINT employments_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: employments employments_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employments
    ADD CONSTRAINT employments_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: employments employments_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employments
    ADD CONSTRAINT employments_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: gift_funds gift_funds_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.gift_funds
    ADD CONSTRAINT gift_funds_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: gift_funds gift_funds_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.gift_funds
    ADD CONSTRAINT gift_funds_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: gift_funds gift_funds_gift_letter_document_id_documents_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.gift_funds
    ADD CONSTRAINT gift_funds_gift_letter_document_id_documents_id_fk FOREIGN KEY (gift_letter_document_id) REFERENCES public.documents(id);


--
-- Name: gift_funds gift_funds_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.gift_funds
    ADD CONSTRAINT gift_funds_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: incomes incomes_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.incomes
    ADD CONSTRAINT incomes_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: incomes incomes_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.incomes
    ADD CONSTRAINT incomes_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: incomes incomes_employment_id_employments_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.incomes
    ADD CONSTRAINT incomes_employment_id_employments_id_fk FOREIGN KEY (employment_id) REFERENCES public.employments(id);


--
-- Name: incomes incomes_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.incomes
    ADD CONSTRAINT incomes_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: invitation_tokens invitation_tokens_application_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.invitation_tokens
    ADD CONSTRAINT invitation_tokens_application_customer_id_fkey FOREIGN KEY (application_customer_id) REFERENCES public.application_customers(id) ON DELETE CASCADE;


--
-- Name: liabilities liabilities_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.liabilities
    ADD CONSTRAINT liabilities_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: liabilities liabilities_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.liabilities
    ADD CONSTRAINT liabilities_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: liability_ownership liability_ownership_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.liability_ownership
    ADD CONSTRAINT liability_ownership_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: liability_ownership liability_ownership_liability_id_liabilities_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.liability_ownership
    ADD CONSTRAINT liability_ownership_liability_id_liabilities_id_fk FOREIGN KEY (liability_id) REFERENCES public.liabilities(id);


--
-- Name: loan_products loan_products_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.loan_products
    ADD CONSTRAINT loan_products_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: notes notes_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.notes
    ADD CONSTRAINT notes_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: notes notes_author_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: notes notes_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.notes
    ADD CONSTRAINT notes_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: notes notes_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.notes
    ADD CONSTRAINT notes_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);
...
--
-- Name: real_estate_owned real_estate_owned_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.real_estate_owned
    ADD CONSTRAINT real_estate_owned_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: real_estate_owned real_estate_owned_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.real_estate_owned
    ADD CONSTRAINT real_estate_owned_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: real_estate_owned real_estate_owned_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.real_estate_owned
    ADD CONSTRAINT real_estate_owned_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: residences residences_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.residences
    ADD CONSTRAINT residences_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: residences residences_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.residences
    ADD CONSTRAINT residences_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: residences residences_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.residences
    ADD CONSTRAINT residences_organization_id_organizations_id_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(id);


--
-- Name: tasks tasks_application_id_applications_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tasks
    ADD CONSTRAINT tasks_application_id_applications_id_fk FOREIGN KEY (application_id) REFERENCES public.applications(id);
...
--
-- Name: tasks tasks_customer_id_customers_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tasks
    ADD CONSTRAINT tasks_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: tasks tasks_organization_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: customers Borrowers can update own customer record; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Borrowers can update own customer record" ON public.customers FOR UPDATE USING ((auth_user_id = ( SELECT auth.uid() AS uid)));


--
-- Name: customers Borrowers can view own customer record; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Borrowers can view own customer record" ON public.customers FOR SELECT USING ((auth_user_id = ( SELECT auth.uid() AS uid)));


--
-- Name: applications Users can create applications; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can create applications" ON public.applications FOR INSERT WITH CHECK ((primary_customer_id IN ( SELECT customers.id
   FROM public.customers
  WHERE (customers.auth_user_id = ( SELECT auth.uid() AS uid)))));


--
-- Name: customers Users can create own customer record; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can create own customer record" ON public.customers FOR INSERT WITH CHECK ((auth_user_id = ( SELECT auth.uid() AS uid)));


--
-- Name: applications Users can update own draft applications; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can update own draft applications" ON public.applications FOR UPDATE USING ((primary_customer_id IN ( SELECT customers.id
   FROM public.customers
  WHERE (customers.auth_user_id = ( SELECT auth.uid() AS uid)))));
...
--
-- Name: applications Users can view own applications; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view own applications" ON public.applications FOR SELECT USING ((primary_customer_id IN ( SELECT customers.id
   FROM public.customers
  WHERE (customers.auth_user_id = ( SELECT auth.uid() AS uid)))));
...
--
-- Name: application_customers; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.application_customers ENABLE ROW LEVEL SECURITY;

--
-- Name: application_events; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: asset_ownership; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: communications; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: declarations; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.declarations ENABLE ROW LEVEL SECURITY;

--
-- Name: demographics; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: employments; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.employments ENABLE ROW LEVEL SECURITY;

--
-- Name: gift_funds; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.gift_funds ENABLE ROW LEVEL SECURITY;

--
-- Name: incomes; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.incomes ENABLE ROW LEVEL SECURITY;

--
-- Name: invitation_tokens; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.invitation_tokens ENABLE ROW LEVEL SECURITY;

--
-- Name: liabilities; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.liabilities ENABLE ROW LEVEL SECURITY;

--
-- Name: liability_ownership; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.liability_ownership ENABLE ROW LEVEL SECURITY;

--
-- Name: loan_products; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: real_estate_owned; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.real_estate_owned ENABLE ROW LEVEL SECURITY;

--
-- Name: residences; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
CREATE POLICY "Allow authenticated deletes" ON storage.objects FOR DELETE TO authenticated USING ((bucket_id = 'documents'::text));
...
CREATE POLICY "Allow authenticated reads" ON storage.objects FOR SELECT TO authenticated USING ((bucket_id = 'documents'::text));
...
CREATE POLICY "Allow authenticated updates" ON storage.objects FOR UPDATE TO authenticated USING ((bucket_id = 'documents'::text));
...
CREATE POLICY "Allow authenticated uploads" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'documents'::text));


--
-- Name: objects Borrowers can delete own documents; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Borrowers can delete own documents" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'borrower-documents'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Borrowers can upload own documents; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Borrowers can upload own documents" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'borrower-documents'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Borrowers can view own documents; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Borrowers can view own documents" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'borrower-documents'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));
...
--
-- Name: TABLE application_customers; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.application_customers TO anon;
GRANT ALL ON TABLE public.application_customers TO authenticated;
GRANT ALL ON TABLE public.application_customers TO service_role;


--
-- Name: TABLE application_events; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE asset_ownership; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.asset_ownership TO anon;
GRANT ALL ON TABLE public.asset_ownership TO authenticated;
GRANT ALL ON TABLE public.asset_ownership TO service_role;
...
--
-- Name: TABLE declarations; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE demographics; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE employments; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.employments TO anon;
GRANT ALL ON TABLE public.employments TO authenticated;
GRANT ALL ON TABLE public.employments TO service_role;


--
-- Name: TABLE gift_funds; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.gift_funds TO anon;
GRANT ALL ON TABLE public.gift_funds TO authenticated;
GRANT ALL ON TABLE public.gift_funds TO service_role;
...
--
-- Name: TABLE invitation_tokens; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE liabilities; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE liability_ownership; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.liability_ownership TO anon;
GRANT ALL ON TABLE public.liability_ownership TO authenticated;
GRANT ALL ON TABLE public.liability_ownership TO service_role;


--
-- Name: TABLE loan_products; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE real_estate_owned; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.real_estate_owned TO anon;
GRANT ALL ON TABLE public.real_estate_owned TO authenticated;
GRANT ALL ON TABLE public.real_estate_owned TO service_role;


--
-- Name: TABLE residences; Type: ACL; Schema: public; Owner: postgres
--
